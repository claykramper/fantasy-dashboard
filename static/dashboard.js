...
function toggleLeagueVisibility(platform) {
    hideLeague[platform] =
        !hideLeague[platform];
...
function toggleHideAllOpponents() {
    hideAllOpponents =
        !hideAllOpponents;
            ...
            <div class="slate-options">
                ...
                <div class="slate-option">
                    <input
                        ...
                        onchange="
                            toggleHideAllOpponents()
                        "
                    >
                    <label
                        for="hide-all-opponents"
                    >
                        Hide All Opponents
                    </label>
                </div>
